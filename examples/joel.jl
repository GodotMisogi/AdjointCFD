## Ported Joel CFD's example to Julia with extensions: https://github.com/joel-ho/Field-inversion-example
# Currently uses Zygote for autodiff
using LinearAlgebra
using Zygote
using StaticArrays
...
function compute_residual_and_grad(T, β, q, dx, dy)
    # Residual
    R = residual(T, β, q, dx, dy, T_boundary)
